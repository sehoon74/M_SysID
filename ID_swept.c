...
//  double time_prv = 0.0;
    ...
    for(i=0;i<RUNNING_T;i++) {
        ...
        freq = pow(10.0,log10(0.3)+log10(300.0)*(double)(RUNNING_T-i)/(double)RUNNING_T);
		Vout=((double)(RUNNING_T-i)/(double)RUNNING_T)*0.4*sin(2.0*M_PI*freq)*(double)i/1000.0;
