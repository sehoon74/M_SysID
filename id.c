...
void mxm(a,b,c)
double	a[2*DIM][2*DIM],b[2*DIM][2*DIM],c[2*DIM][2*DIM];
{
	int 	i,j,k;
	double 	s;
	for ( i=0 ; i<2*DIM ; ++i )
...
void mxv(a,b,c)
double	a[2*DIM][2*DIM],b[2*DIM],c[2*DIM];
{
	int 	i,k;
	double 	s;
	for ( i=0 ; i<2*DIM ; ++i )
...
void vxm(a,b,c)
double	a[2*DIM],b[2*DIM][2*DIM],c[2*DIM];
{
	int 	i,k;
	double 	s;
	for ( i=0 ; i<2*DIM ; ++i )
...
void kxm(a,b,c)
double a,b[2*DIM][2*DIM],c[2*DIM][2*DIM];
{
	int i,j;
...
void vpv(a,b,c)
double a[2*DIM],b[2*DIM],c[2*DIM];
{
	int k;
...
void mvxv(a,b,c)
double	a[2*DIM],b[2*DIM],c[2*DIM][2*DIM];
{
	int 	i,j;
...
void mupdate(a,b)
double	a[2*DIM][2*DIM],b[2*DIM][2*DIM];
{
	int 	i,j;
